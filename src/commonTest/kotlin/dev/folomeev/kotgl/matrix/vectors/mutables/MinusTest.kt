...
class MinusTest {
    ...
    @Test
    fun vec4_minusTo() =
        assertEquals(-1f, 1f, -1f, 1f, vec4(1f, 4f, 5f, 8f).minusTo(vec4(2f, 3f, 6f, 7f), mutableVec4()))
    ...
    @Test
    fun mutableVec4_minusSelf() =
        assertEquals(-1f, 1f, -1f, 1f, mutableVec4(1f, 4f, 5f, 8f).minusSelf(vec4(2f, 3f, 6f, 7f)))
}